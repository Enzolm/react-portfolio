  ...
  return (
    <>
      <div className="mt-6 container mx-auto p-6 bg-base-100 shadow-lg rounded-xl">
        <h1 className="text-4xl font-bold text-white mb-6 text-center">Rame Différée</h1>

        <div className="rounded-2xl bg-neutral-content p-8 shadow-lg">
          <div className="flex justify-center">
            <img src={IMG_crud_home} className="h-44 rounded-lg shadow-lg" alt="Logo" />
          </div>
          <p className="mt-6 text-lg text-neutral-700 leading-relaxed">La rame différée est un projet qui consiste à créer une application web permettant de voir les dossiers Rame Différée en cours.</p>

          <h2 className="text-2xl font-semibold mt-8 text-secondary">Objectif</h2>
          <p className="text-neutral-600 mt-2">L'objectif est de numériser un processus papier.</p>

          <h2 className="text-2xl font-semibold mt-8 text-secondary">Outils :</h2>
          ...
          <h2 className="text-2xl font-semibold mt-8 text-secondary">Images :</h2>
